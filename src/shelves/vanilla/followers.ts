...
export const jwfollowers: Shelf = {
  ...
  areas: [
    {
      expression:
        "[cheyenne_a] || [cheyenne_b] || [cheyenne_c] || [cheyenne_r] || [cheyenne_p] || [cheyenne_d]",
    },

    {
      expression:
        "[joshua_a] || [joshua_b] || [joshua_c] || [joshua_r] || [joshua_p] || [joshua_d]",
      x: 1,
      y: 2,
    },
    {
      expression:
        "[jesse_a] || [jesse_b] || [jesse_c] || [jesse_r] || [jesse_p] || [jesse_d]",
      x: 1,
      y: 3,
    },
    {
    ...
    {
      expression:
        "[brayden_a] || [brayden_b] || [brayden_c] || [brayden_r] || [brayden_p] || [brayden_d]",
      x: 6,
      y: 3,
    },
    {
    ...
    {
      expression:
        "[karina_a] || [karina_b] || [karina_c] || [karina_r] || [karina_p] || [karina_d]",
      x: 8,
      y: 1,
    },
    {
